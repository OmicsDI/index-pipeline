...
/**
 * Created by yperez on 25/07/2016.
 */


@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"classpath:jobs/mw/ddi-indexer-test-mw-import-only.xml"})
public class ImportOnlyEBeyeMwXMLTaskLetTest {
